...
+ No holisitc view of scenarion based risks
+ Hard to reuse/refine current documentation and toolsets
+ Dificult to use

### Solution Space

The To-Be futue state:
...
+ Developed using an open framework, publically available, leveraged by extending exsiting ISO 27K framework approach through enhanced enterprise ready solutions.
...
+ Ability to be used in either an on-line or off-line mode.
...
To achieve these goals the proejct will start with a pre-defined set of inputs:
