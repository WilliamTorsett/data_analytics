...
```{r Example Question, cache=FALSE,echo=FALSE}
renderPrint("How inportant is the Business As Usual Security regime of the <information asset>")
renderPrint('1: The data-to-day security of the <information asset> is really not essential')
renderPrint('2: The data-to-day security of the <information asset> is not essential')
renderPrint('3: The data-to-day security of the <information asset> neither not essential or essential.')
renderPrint('4: The data-to-day security of the <information asset> is essential.')
renderPrint('5: The data-to-day security of the <information asset> is really essential.')

sliderInput(
  inputId = 'Question_Example', label = 'BAU Security Slider',
