...
```{r Example Question, cache=FALSE,echo=TRUE}
renderText("How inportant is the Business As Usual Security regime of the <information asset>.")
```
```{r render-text-3,cache=FALSE, echo=FALSE}
renderText(" ")
renderText("1: The data-to-day security of the 'information asset' is really not essential.")
```

2: The data-to-day security of the 'information asset' is not essential

3: The data-to-day security of the 'information asset' is neither not essential or essential.

4: The data-to-day security of the 'information asset' is essential.

5: The data-to-day security of the 'information asset' is really essential.
